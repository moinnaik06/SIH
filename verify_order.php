...
<div class="content">
  <form action="verification_process.php" method="post">
    <label class="edit" style="color: #009900"> Verification </label> <br> <br>
    <div align="center"> 
      <?php
        $order_id = $_GET['order_id'];
        echo "<label> Order ID: </label> <input type='text' name='order_id' value='".$order_id."' style='border:none;' readonly size='12px'> <br>";
      ?>
   <br>
    </div>
     <label>Delivery code: </label> <input type="text" name="verification_code"align="center" size="7px">
