...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en'}, 'google_translate_element');
    ...
    <section class="ftco-section contact-section " style="color: black">
      <div class="container">
    <div class="row block-12">
         <div class="col-md-4 d-flex"></div>
        <div class="col-md-4 d-flex">
            <form  action="centre_login.php" method="post" class=" p-5 contact-form" data-callback="XXX">
              <div align="center">
                <h4>Admin Login</h4> 
              </div>
              <div class="form-group">
                ...
                <input type="text" name="login_id" class="form-control" placeholder="Your Id" required="id" align="center" >
              </div>
              <div class="form-group">
                <div align="center">
                <label><b> Password </b></label>
                </div>
                <input type="password" name="pass" class="form-control" placeholder="Your Password" required="password" align="center" >
              </div>
      ...
      <div class="g-recaptcha" data-sitekey="6LfBk84UAAAAAO9GYhgjewnmq70uUHyB_JxIjoXr" data-callback="recaptchaCallback" align="center" ></div>
        <script type="text/javascript">
    ...
    $('#submitBtn').removeAttr('disabled');
              ...
              <div class="form-group" align="center">
                <input type="submit" id="submitBtn" value="Submit" class="btn btn-primary py-3 px-5" disabled><a href="center_farmer_details.php"></a>
              </div>
            </form>  
          </div>
